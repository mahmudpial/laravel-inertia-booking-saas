...
const submitSettings = () => {
    form.post(route('admin.settings.update'), {
        preserveScroll: true,
        onSuccess: () => {
            // Smooth feedback handled via Flash Messages or Inertia State
        }
    });
};
</script>
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div v-if="$page.props.flash?.message"
                    class="mb-6 p-4 bg-green-50 text-green-700 text-sm rounded-lg shadow-sm font-medium border border-green-200 transition-all duration-300">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea v-model="form.description" rows="4"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                        placeholder="Tell your clients about your premium salon treatments, specialized clinical expertise..."></textarea>
                                ...
                                <div>
                                    ...
                                    <input v-model="form.address" type="text"
                                        class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                        placeholder="e.g. 452 Elite Corporate Way, Suite 10" />
